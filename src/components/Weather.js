...
const neonHoverAnimation = keyframes`
  ...
  100% {
    filter: brightness(1.1) blur(0.05px) contrast(1.2);
    box-shadow: 0 0 5px #fff, 0 0 10px #fff, 0 0 15px #00ffcc, 0 0 20px #00ffcc;
  }
`;
...
const Weather = () => {
  ...
  const API_KEY = '275f4340904f6dc593c143b8478c0594'; // Replace with your OpenWeatherMap API key
  const UNSPLASH_ACCESS_KEY = '-zGd2xvB8TkmEHERbiZBu-TfTe9YA7zM4z8FShRP678'; // Replace with your Unsplash API key
...
<p style={{ color: 'black' }}>Wind Speed: {weatherData.wind.speed} m/s <WiStrongWind style={{ fontSize: '1.5rem' }} /></p>
        ...
        <SocialIcons>
          <SocialIcon href="https://www.instagram.com/itspranav_____/" target="_blank" rel="noopener noreferrer">
            <FaInstagram />
          </SocialIcon>
          <SocialIcon href="https://www.github.com/Pranav-1100" target="_blank" rel="noopener noreferrer">
            <FaGithub />
          </SocialIcon>
          <SocialIcon href="https://www.linkedin.com/in/pranav-aggarwal-474554231/" target="_blank" rel="noopener noreferrer">
            <FaLinkedin />
          </SocialIcon>
        </SocialIcons>
      </BlurCard>
